...
8. Фікс багів:
    ...
    - фікс дизайну селекторів, випадаючого меню вибору департаментів, скроллбар;
    - додавання localStorage для першої сторінки EditUser;
    - додавання localStorage для другої сторінки Users;